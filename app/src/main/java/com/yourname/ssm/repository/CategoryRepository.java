...
public class CategoryRepository {
    ...
    public long insertCategory(Category category) {
        ...
        values.put("icon", category.getIconResourceId());
    ...
    public int deleteCategory(int categoryId) {
        SQLiteDatabase db = getDbHelper().getWritableDatabase();
        return db.delete("categories", "id = ?", new String[]{String.valueOf(categoryId)});
    }

    public List<Category> getDefaultCategories(int type) {
        List<Category> defaultCategories = new ArrayList<>();
        
        Log.d(TAG, "Creating default categories for type: " + (type == 1 ? "income" : "expense"));
        
        if (type == 0) { // Chi tiêu
            // Danh mục chi tiêu cơ bản
            defaultCategories.add(new Category(1, "Ăn uống", R.drawable.ic_category_food, 0));
            defaultCategories.add(new Category(2, "Di chuyển", R.drawable.ic_category_transport, 0));
            defaultCategories.add(new Category(3, "Mua sắm", R.drawable.ic_category_shopping, 0));
            defaultCategories.add(new Category(4, "Giải trí", R.drawable.ic_category_entertainment, 0));
            defaultCategories.add(new Category(5, "Y tế", R.drawable.ic_category_health, 0));
            defaultCategories.add(new Category(6, "Giáo dục", R.drawable.ic_category_education, 0));
            defaultCategories.add(new Category(7, "Sách, học tập", R.drawable.ic_category_books, 0));
            defaultCategories.add(new Category(8, "Công nghệ", R.drawable.ic_category_tech, 0));
            defaultCategories.add(new Category(9, "Tiện ích", R.drawable.ic_category_utilities, 0));
            
            // Thêm danh mục chi tiêu mở rộng với các icon mới
            defaultCategories.add(new Category(10, "Cafe, giải khát", R.drawable.ic_category_coffee, 0));
            defaultCategories.add(new Category(11, "Du lịch", R.drawable.ic_category_travel, 0));
            defaultCategories.add(new Category(12, "Thú cưng", R.drawable.ic_category_pet, 0));
            defaultCategories.add(new Category(13, "Làm đẹp", R.drawable.ic_category_beauty, 0));
            defaultCategories.add(new Category(14, "Thể thao", R.drawable.ic_category_fitness, 0));
            defaultCategories.add(new Category(15, "Nhà ở", R.drawable.ic_category_housing, 0));
            defaultCategories.add(new Category(16, "Bảo hiểm", R.drawable.ic_category_insurance, 0));
            defaultCategories.add(new Category(17, "Vay nợ", R.drawable.ic_category_loan, 0));
            defaultCategories.add(new Category(18, "Khác", android.R.drawable.ic_menu_more, 0));
        } else { // Thu nhập
            // Danh mục thu nhập
            defaultCategories.add(new Category(19, "Lương", R.drawable.ic_category_salary, 1));
            defaultCategories.add(new Category(20, "Quà tặng", R.drawable.ic_category_gift, 1));
            defaultCategories.add(new Category(21, "Học bổng", R.drawable.ic_category_education, 1));
            defaultCategories.add(new Category(22, "Bán hàng", R.drawable.ic_category_shopping, 1));
            defaultCategories.add(new Category(23, "Đầu tư", R.drawable.ic_category_investment, 1));
            defaultCategories.add(new Category(24, "Cho vay", R.drawable.ic_category_loan, 1));
            defaultCategories.add(new Category(25, "Thưởng", R.drawable.ic_category_gift, 1));
            defaultCategories.add(new Category(26, "Hoàn tiền", R.drawable.ic_category_tech, 1));
            defaultCategories.add(new Category(27, "Thu nhập phụ", R.drawable.ic_category_utilities, 1));
            defaultCategories.add(new Category(28, "Khác", android.R.drawable.ic_menu_more, 1));
        }
        
        // Thêm các danh mục mặc định vào cơ sở dữ liệu
        for (Category category : defaultCategories) {
            try {
                // Kiểm tra tính hợp lệ của resource ID trước khi thêm vào DB
                if (category.getIconResourceId() <= 0 || !isValidResourceId(category.getIconResourceId())) {
                    Log.w(TAG, "Invalid resource ID for category: " + category.getName() + ", replacing with default");
                    category.setIconResourceId(android.R.drawable.ic_menu_help);
                }
                
                long result = addCategory(category);
                Log.d(TAG, "Added default category: " + category.getName() + ", result: " + result);
            } catch (Exception e) {
                Log.e(TAG, "Error adding default category: " + category.getName(), e);
            }
        }
    ...
    public long addCategory(Category category) {
        ...
        try {
            ...
            Log.e(TAG, "Error adding/updating category: " + category.getName(), e);
        }
