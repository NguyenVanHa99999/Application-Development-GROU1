...
public class TransactionHistoryFragment extends Fragment {
    ...
    private void applyFilters() {
        try {
            ...
            Toast.makeText(requireContext(), "Lỗi lọc dữ liệu: " + e.getMessage(), Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void showDateFilterDialog() {
        try {
            ...
            Toast.makeText(requireContext(), "Lỗi hiển thị dialog chọn ngày: " + e.getMessage(), Toast.LENGTH_SHORT).show();
        }
    }
        ...
        try {
            executor.execute(() -> {
                try {
                    ...
                    requireActivity().runOnUiThread(() -> 
                        Toast.makeText(requireContext(), "Lỗi tải danh mục: " + e.getMessage(), Toast.LENGTH_SHORT).show()
                    );
                }
            });
        } catch (Exception e) {
            Log.e(TAG, "Error showing category filter dialog", e);
            Toast.makeText(requireContext(), "Lỗi hiển thị dialog chọn danh mục: " + e.getMessage(), Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void showTransactionDetailDialog(Transaction transaction) {
        try {
            ...
            // Thiết lập dữ liệu
            titleTextView.setText(transaction.isIncome() ? "Chi tiết thu nhập" : "Chi tiết chi tiêu");
            ...
            if (!TextUtils.isEmpty(transaction.getNote())) {
                ...
                noteTextView.setText("Không có ghi chú");
            }
            ...
            Toast.makeText(requireContext(), "Lỗi hiển thị chi tiết giao dịch: " + e.getMessage(), Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void showEditTransactionDialog(Transaction transaction) {
        try {
            ...
            // Thiết lập dữ liệu
            titleTextView.setText("Chỉnh sửa " + (transaction.isIncome() ? "thu nhập" : "chi tiêu"));
                ...
                executor.execute(() -> {
                    try {
                        ...
                        requireActivity().runOnUiThread(() -> {
                            ...
                            catBuilder.setTitle("Chọn danh mục");
                            ...
                            catBuilder.setNegativeButton("Hủy", (dialog, which) -> dialog.dismiss());
            ...
            dialogView.findViewById(R.id.btn_save).setOnClickListener(v -> {
                try {
                        ...
                        try {
                            ...
                            requireActivity().runOnUiThread(() -> {
                                if (success) {
                                    ...
                                    Toast.makeText(requireContext(), "Lỗi cập nhật giao dịch", Toast.LENGTH_SHORT).show();
                                }
                                dialog.dismiss();
                            });
                        } catch (Exception e) {
                            ...
                            requireActivity().runOnUiThread(() -> {
                                Toast.makeText(requireContext(), "Lỗi cập nhật giao dịch: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                                dialog.dismiss();
                            });
                        }
                    });
                    ...
                    Toast.makeText(requireContext(), "Lỗi lưu giao dịch: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                }
            });
            ...
            Toast.makeText(requireContext(), "Lỗi hiển thị dialog chỉnh sửa: " + e.getMessage(), Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void showDeleteConfirmationDialog(Transaction transaction) {
        try {
                    ...
                    try {
                        ...
                        requireActivity().runOnUiThread(() -> {
                            if (success) {
                                ...
                                Toast.makeText(requireContext(), "Lỗi xóa giao dịch", Toast.LENGTH_SHORT).show();
                            }
                        });
                    } catch (Exception e) {
                        Log.e(TAG, "Error deleting transaction", e);
                        requireActivity().runOnUiThread(() -> 
                            Toast.makeText(requireContext(), "Lỗi xóa giao dịch: " + e.getMessage(), Toast.LENGTH_SHORT).show()
                        );
                    }
                });
            });
            ...
            Toast.makeText(requireContext(), "Lỗi hiển thị dialog xác nhận: " + e.getMessage(), Toast.LENGTH_SHORT).show();
        }
    }
