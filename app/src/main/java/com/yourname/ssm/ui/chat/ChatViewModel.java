...
public class ChatViewModel extends AndroidViewModel {
    ...
    public ChatViewModel(@NonNull Application application) {
        ...
        userId = prefs.getInt("user_id", 1); // Default là 1 nếu không tìm thấy
    ...
    public void sendMessage(String message) {
        try {
            ...
            // Lấy phản hồi từ AI
            chatRepository.getReplyToMessage(message, userId, new ChatCallback() {
                @Override
                public void onMessageReceived(ChatMessage replyMessage) {
                    // Cập nhật LiveData với tin nhắn phản hồi
                    List<ChatMessage> updatedMessages = messagesLiveData.getValue();
    ...
    private void getInitialGreeting() {
        try {
            ...
            chatRepository.getInitialGreeting(userId, new ChatCallback() {
                @Override
                public void onMessageReceived(ChatMessage message) {
                    // Cập nhật LiveData với lời chào
