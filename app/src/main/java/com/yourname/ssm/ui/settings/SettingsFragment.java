...
public class SettingsFragment extends Fragment {
    ...
    private void hideEditProfileUI() {
        ...
        editProfileButton.setText("Chỉnh sửa");
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        if (requestCode == REQUEST_PERMISSIONS) {
            ...
            if (allPermissionsGranted) {
                ...
                Toast.makeText(requireContext(), "Ứng dụng cần quyền truy cập để hoạt động", Toast.LENGTH_SHORT).show();
            }
        } else {
    ...
    private void dispatchTakePictureIntent() {
        try {
            ...
            if (ContextCompat.checkSelfPermission(requireContext(), Manifest.permission.CAMERA) 
                    != PackageManager.PERMISSION_GRANTED) {
                Toast.makeText(requireContext(), "Ứng dụng cần quyền truy cập máy ảnh", Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(requireContext(), "Lỗi khi mở máy ảnh: " + e.getMessage(), Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK) {
            if (requestCode == PICK_IMAGE_REQUEST) {
                ...
                try {
                    Log.d("SettingsFragment", "Đã nhận kết quả từ camera, xử lý ảnh...");
                    ...
                    if (data != null && data.getExtras() != null && data.getExtras().containsKey("data")) {
                        Log.d("SettingsFragment", "Xử lý ảnh từ thumbnail trong intent data");
                        Bitmap thumbnail = (Bitmap) data.getExtras().get("data");
                        if (thumbnail != null) {
                            // Áp dụng ảnh trực tiếp
                            Log.d("SettingsFragment", "Đã nhận được thumbnail, kích thước: " + 
                    ...
                    if (photoURI != null) {
                        Log.d("SettingsFragment", "Xử lý ảnh từ URI: " + photoURI);
                    ...
                    if (currentPhotoPath != null) {
                        Log.d("SettingsFragment", "Xử lý ảnh từ file path: " + currentPhotoPath);
                        ...
                        if (file.exists()) {
                            ...
                            Log.e("SettingsFragment", "File không tồn tại: " + currentPhotoPath);
                        }
                    }
                    
                    // Nếu không xử lý được ảnh
                    Toast.makeText(requireContext(), "Không thể xử lý ảnh chụp, vui lòng thử lại", Toast.LENGTH_SHORT).show();
                    
                } catch (Exception e) {
                    Log.e("SettingsFragment", "Error processing captured image", e);
                    Toast.makeText(requireContext(), "Lỗi khi xử lý ảnh chụp: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                }
                ...
                try {
                    ...
                    Toast.makeText(requireContext(), "Lỗi khi xử lý video: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                }
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R) {
                    if (Environment.isExternalStorageManager()) {
                        ...
                        Toast.makeText(requireContext(), 
                            "Cần quyền quản lý bộ nhớ để lưu trữ ảnh", 
                            Toast.LENGTH_SHORT).show();
                    }
                }
            }
        } else if (resultCode == Activity.RESULT_CANCELED) {
            Toast.makeText(requireContext(), "Thao tác bị hủy", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void saveImageToSharedPreferencesAndServer(final Bitmap bitmap) {
        ...
        try {
            if (bitmap == null) {
                Log.e("SettingsFragment", "Bitmap null, không thể lưu và tải lên database");
                return;
            }
            
            Log.d("SettingsFragment", "Bắt đầu lưu avatar vào SharedPreferences và đồng bộ với navigation drawer");
            ...
            new Thread(() -> {
                try {
                    ...
                    if (!dbSuccess) {
                        ...
                        Log.d("SettingsFragment", "Lần đầu lưu vào database thất bại, thử lại lần nữa");
            ...
            Log.e("SettingsFragment", "Lỗi khi lưu và tải ảnh lên database: " + e.getMessage(), e);
            if (shouldShowAvatarUpdateToast) {
                Toast.makeText(requireContext(), "Đã lưu ảnh đại diện nhưng không thể đồng bộ với database", Toast.LENGTH_SHORT).show();
                shouldShowAvatarUpdateToast = false;
            }
        }
    }
    ...
    private boolean uploadImageToDatabase(Bitmap bitmap) {
        try {
            if (bitmap == null) {
                Log.e("SettingsFragment", "Bitmap null, không thể lưu vào database");
                return false;
            }
            ...
            if (getActivity() != null && hasManuallyChangedAvatar) {
                getActivity().runOnUiThread(() -> {
                    ...
                    // Toast.makeText(requireContext(), "Đang lưu ảnh vào cơ sở dữ liệu...", Toast.LENGTH_SHORT).show();
                });
            }
            ...
            if (getActivity() != null && hasManuallyChangedAvatar && !success) {
                getActivity().runOnUiThread(() -> {
                    Toast.makeText(requireContext(), "Lỗi khi lưu ảnh vào cơ sở dữ liệu", Toast.LENGTH_SHORT).show();
                });
            }
    ...
    private void changePassword() {
        ...
        Toast.makeText(requireContext(), "Đã cập nhật mật khẩu thành công", Toast.LENGTH_SHORT).show();
    ...
    private void updateBudget() {
        ...
        if (TextUtils.isEmpty(budgetAmountStr)) {
            budgetAmountLayout.setError("Vui lòng nhập số tiền ngân sách");
            return;
        } else {
        ...
        try {
            ...
            if (newBudgetAmount < 0) {
                budgetAmountLayout.setError("Ngân sách không thể âm");
                return;
            }
            ...
            Toast.makeText(requireContext(), "Đã cập nhật ngân sách thành công", Toast.LENGTH_SHORT).show();
            ...
            budgetAmountLayout.setError("Số tiền không hợp lệ");
        }
    }
    ...
    private void applyTheme() {
        ...
        // Show message
        Toast.makeText(requireContext(), "Đã thay đổi giao diện", Toast.LENGTH_SHORT).show();
    }
    ...
    private void saveImageToSharedPreferences(Bitmap bitmap) {
        try {
            if (bitmap == null) {
                Log.e("SettingsFragment", "Bitmap null, không thể lưu vào SharedPreferences");
                return;
            }
            ...
            Log.d("SettingsFragment", "Thông tin hiện tại trước khi lưu - Username: " + 
            ...
            if (encodedImage != null) {
                ...
                Log.d("SettingsFragment", "Đã lưu ảnh vào SharedPreferences: " + (success ? "thành công" : "thất bại"));
                ...
                if (getActivity() instanceof MainActivity) {
                    ...
                    Log.d("SettingsFragment", "Đã cập nhật avatar trong navigation drawer, giữ nguyên username và email");
                    ...
                    try {
                        ...
                        if (navigationView != null) {
                            ...
                            if (headerView != null) {
                                ...
                                Log.d("SettingsFragment", "Sau khi cập nhật - Username: " + 
                                      (navUsername != null ? navUsername.getText() : "null") + 
                                      ", Email: " + (navEmail != null ? navEmail.getText() : "null"));
                            }
                        }
                    } catch (Exception e) {
                        Log.e("SettingsFragment", "Lỗi khi kiểm tra navigation drawer sau khi cập nhật", e);
                    }
                } else {
                    Log.e("SettingsFragment", "Activity không phải là MainActivity");
                }
            } else {
                Log.e("SettingsFragment", "Không thể mã hóa bitmap sang Base64");
            }
        } catch (Exception e) {
            Log.e("SettingsFragment", "Lỗi khi lưu ảnh vào SharedPreferences: " + e.getMessage(), e);
        }
    }
    ...
    private String bitmapToBase64(Bitmap bitmap) {
        ...
        try {
            ...
            Log.e("SettingsFragment", "Lỗi khi chuyển đổi bitmap sang Base64: " + e.getMessage());
            return null;
        }
    }
        ...
        try {
            for (int i = 0; i < viewGroup.getChildCount(); i++) {
                ...
                if (child instanceof ViewGroup) {
                    ...
                    if (text.contains("Không tìm thấy ứng dụng máy ảnh")) {
                        textView.setVisibility(View.GONE);
                        Log.d("SettingsFragment", "Đã ẩn thông báo lỗi camera");
                    }
                }
            }
        } catch (Exception e) {
